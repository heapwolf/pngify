  ...
  while (true) {
    ...
    switch (section) {
      ...
      case 'PLTE':
        ...
        break;
      case 'IDAT':
        for (var i = _i = 0; _i < chunkSize; i = _i += 1) {
      ...
      case 'tRNS':
        ...
        switch (this.colorType) {
          case 3:
            ...
            if (short > 0) {
              for (var i = _j = 0; 0 <= short ? _j < short : _j > short; i = 0 <= short ? ++_j : --_j) {
...
PNG.prototype.read = function(bytes) {
  var _i;
  var results = [];
  for (var i = _i = 0; 0 <= bytes ? _i < bytes : _i > bytes; i = 0 <= bytes ? ++_i : --_i) {
...
PNG.prototype.decode = function(fn) {
  ...
  this.decodePixels(function(pixels) {
    that.copyToImageData(buf, pixels)
    fn(buf)
  })
}
